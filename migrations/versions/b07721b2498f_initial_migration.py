...
Revision ID: b07721b2498f
Revises: 8da948219dc1
Create Date: 2022-03-16 00:28:20.665499
...
revision = 'b07721b2498f'
down_revision = '8da948219dc1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('invoiced', sa.String(length=100), nullable=False),
    sa.Column('month_invoiced', sa.String(length=50), nullable=True),
    sa.Column('product_at_co', sa.String(length=100), nullable=False),
