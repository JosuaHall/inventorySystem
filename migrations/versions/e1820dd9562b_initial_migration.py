...
Revision ID: e1820dd9562b
Revises: 80c1272ad0b9
Create Date: 2022-03-15 23:47:56.843965
...
revision = 'e1820dd9562b'
down_revision = '80c1272ad0b9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('prouct_at_co', sa.Boolean(), nullable=True),
